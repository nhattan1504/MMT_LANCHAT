 ...
 * @author ktant
 */
public class GUI_PrivateMessage extends javax.swing.JFrame {
...
//Nut gui tin nhan rieng tu, chi 2 nguoi chat voi nhau co the thay duoc.
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         
        String msgg = jTextField1.getText();
        String target = jTextField2.getText();
        username = jTextField3.getText();
        
        if(!msgg.isEmpty() && !target.isEmpty()){
            jTextField1.setText("");
            client.send(new Message("message", username, msgg, target));
        }        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_PrivateMessage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_PrivateMessage().setVisible(true);
            }
        });
    }
