...
public class SocketClient implements Runnable{
    ...
    public GUI_User ui;
    public GUI_PrivateMessage privateui;
    ...
    public SocketClient(GUI_User frame) throws IOException{
...
//                        privateui.jTextArea1.append("["+msg.sender +" > Me] : " + msg.content + "\n");
//                    }
//                    else{
//                        privateui.jTextArea1.append("["+ msg.sender +" > "+ msg.recipient +"] : " + msg.content + "\n");
//                    }
//                                            
